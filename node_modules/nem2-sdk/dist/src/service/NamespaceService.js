...
class NamespaceService {
    ...
    namespace(id) {
        return this.namespaceHttp.getNamespace(id)
            .flatMap((namespaceInfo) => this.namespaceHttp
            .getNamespacesName(namespaceInfo.levels)
            .map((names) => Object.assign({ __proto__: Object.getPrototypeOf(namespaceInfo) }, namespaceInfo, { name: this.extractFullNamespace(namespaceInfo, names) })));
    }
