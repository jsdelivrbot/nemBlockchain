...
class Listener {
    ...
    newBlock() {
        ...
        return this.messageSubject.asObservable()
            ...
            .filter((_) => _.message instanceof BlockInfo_1.BlockInfo)
            .map((_) => _.message);
    }
    /**
    ...
    confirmed(address) {
        ...
        return this.messageSubject.asObservable()
            ...
            .filter((_) => _.message instanceof Transaction_1.Transaction)
            .map((_) => _.message)
    ...
    aggregateBondedAdded(address) {
        ...
        return this.messageSubject.asObservable()
            ...
            .filter((_) => _.message instanceof AggregateTransaction_1.AggregateTransaction)
            .map((_) => _.message)
            .filter((_) => this.transactionFromAddress(_, address));
    }
    /**
    ...
    status(address) {
        ...
        return this.messageSubject.asObservable()
            ...
            .filter((_) => _.message instanceof TransactionStatusError_1.TransactionStatusError)
            .map((_) => _.message);
    }
    /**
    ...
    cosignatureAdded(address) {
        ...
        return this.messageSubject.asObservable()
            ...
            .filter((_) => _.message instanceof CosignatureSignedTransaction_1.CosignatureSignedTransaction)
            .map((_) => _.message);
    }
    /**
     * @internal
