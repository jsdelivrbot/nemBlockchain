...
class BlockchainHttp extends Http_1.Http {
    ...
    getBlockByHeight(height) {
        return Observable_1.Observable.fromPromise(this.blockchainRoutesApi.getBlockByHeight(height)).map((blockDTO) => {
    ...
    getBlockTransactions(height, queryParams) {
        return Observable_1.Observable.fromPromise(this.blockchainRoutesApi.getBlockTransactions(height, queryParams != null ? queryParams : {})).map((transactionsDTO) => {
    ...
    getBlocksByHeightWithLimit(height, limit = 1) {
        return Observable_1.Observable.fromPromise(this.blockchainRoutesApi.getBlocksByHeightWithLimit(height, limit)).map((blocksDTO) => {
     ...
     */
    getBlockchainHeight() {
        return Observable_1.Observable.fromPromise(this.blockchainRoutesApi.getBlockchainHeight()).map((heightDTO) => {
     ...
     */
    getBlockchainScore() {
        return Observable_1.Observable.fromPromise(this.blockchainRoutesApi.getBlockchainScore()).map((blockchainScoreDTO) => {
    ...
    getDiagnosticStorage() {
        return Observable_1.Observable.fromPromise(this.blockchainRoutesApi.getDiagnosticStorage()).map((blockchainStorageInfoDTO) => {
