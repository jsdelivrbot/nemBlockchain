...
const MosaicName_1 = require("../model/mosaic/MosaicName");
...
class MosaicHttp extends Http_1.Http {
    ...
    getMosaic(mosaicId) {
        return this.getNetworkTypeObservable()
            .flatMap((networkType) => Observable_1.Observable.fromPromise(this.mosaicRoutesApi.getMosaic(mosaicId.toHex())).map((mosaicInfoDTO) => {
    ...
    getMosaics(mosaicIds) {
        ...
        return this.getNetworkTypeObservable()
            .flatMap((networkType) => Observable_1.Observable.fromPromise(this.mosaicRoutesApi.getMosaics(mosaicIdsBody)).map((mosaicInfosDTO) => {
    ...
    getMosaicsFromNamespace(namespaceId, queryParams) {
        return this.getNetworkTypeObservable()
            .flatMap((networkType) => Observable_1.Observable.fromPromise(this.mosaicRoutesApi.getMosaicsFromNamespace(namespaceId.toHex(), queryParams != null ? queryParams : {}))
    ...
    getMosaicsName(mosaicIds) {
        ...
        return Observable_1.Observable.fromPromise(this.mosaicRoutesApi.getMosaicsName(mosaicIdsBody)).map((mosaicInfosDTO) => {
            return mosaicInfosDTO.map((mosaicInfoDTO) => {
