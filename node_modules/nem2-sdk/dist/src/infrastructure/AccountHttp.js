...
class AccountHttp extends Http_1.Http {
    ...
    getAccountInfo(address) {
        return Observable_1.Observable.fromPromise(this.accountRoutesApi.getAccountInfo(address.plain())).map((accountInfoDTO) => {
    ...
    getAccountsInfo(addresses) {
        ...
        return Observable_1.Observable.fromPromise(this.accountRoutesApi.getAccountsInfo(accountIdsBody)).map((accountsInfoMetaDataDTO) => {
    ...
    getMultisigAccountInfo(address) {
        return this.getNetworkTypeObservable()
            .flatMap((networkType) => Observable_1.Observable.fromPromise(this.accountRoutesApi.getAccountMultisig(address.plain())).map((multisigAccountInfoDTO) => {
    ...
    getMultisigAccountGraphInfo(address) {
        return this.getNetworkTypeObservable()
            .flatMap((networkType) => Observable_1.Observable.fromPromise(this.accountRoutesApi.getAccountMultisigGraph(address.plain())).map((multisigAccountGraphInfosDTO) => {
    ...
    transactions(publicAccount, queryParams) {
        return Observable_1.Observable.fromPromise(this.accountRoutesApi.transactions(publicAccount.publicKey, queryParams != null ? queryParams : {}))
            .map((transactionsDTO) => {
    ...
    incomingTransactions(publicAccount, queryParams) {
        return Observable_1.Observable.fromPromise(this.accountRoutesApi.incomingTransactions(publicAccount.publicKey, queryParams != null ? queryParams : {}))
            .map((transactionsDTO) => {
            return transactionsDTO.map((transactionDTO) => {
                return CreateTransactionFromDTO_1.CreateTransactionFromDTO(transactionDTO);
            });
    ...
    outgoingTransactions(publicAccount, queryParams) {
        return Observable_1.Observable.fromPromise(this.accountRoutesApi.outgoingTransactions(publicAccount.publicKey, queryParams != null ? queryParams : {}))
            .map((transactionsDTO) => {
            return transactionsDTO.map((transactionDTO) => {
                return CreateTransactionFromDTO_1.CreateTransactionFromDTO(transactionDTO);
            });
    ...
    unconfirmedTransactions(publicAccount, queryParams) {
        return Observable_1.Observable.fromPromise(this.accountRoutesApi.unconfirmedTransactions(publicAccount.publicKey, queryParams != null ? queryParams : {}))
            .map((transactionsDTO) => {
            return transactionsDTO.map((transactionDTO) => {
                return CreateTransactionFromDTO_1.CreateTransactionFromDTO(transactionDTO);
            });
    ...
    aggregateBondedTransactions(publicAccount, queryParams) {
        return Observable_1.Observable.fromPromise(this.accountRoutesApi.partialTransactions(publicAccount.publicKey, queryParams != null ? queryParams : {}))
            .map((transactionsDTO) => {
            return transactionsDTO.map((transactionDTO) => {
                return CreateTransactionFromDTO_1.CreateTransactionFromDTO(transactionDTO);
            });
