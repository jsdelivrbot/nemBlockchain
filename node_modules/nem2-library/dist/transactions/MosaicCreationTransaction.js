...
var _MosaicCreationTransactionSchema2 = _interopRequireDefault(_MosaicCreationTransactionSchema);
		...
		get: function get() {
			var Builder = function () {
				...
				_createClass(Builder, [{
					...
					key: 'addMosaicName',
					value: function addMosaicName(mosaicName) {
					...
					value: function build() {
						...
						var mosaicNameLength = _convert2.default.utf8ToHex(this.mosaicName).length / 2;
						...
						var parentIdVector = MosaicCreationTransactionBuffer.createParentIdVector(builder, this.parentId);
						var mosaicIdVector = MosaicCreationTransactionBuffer.createMosaicIdVector(builder, this.mosaicId);

						var mosaicName = builder.createString(this.mosaicName);
						...
						return new MosaicCreationTransaction(bytes, _MosaicCreationTransactionSchema2.default);
					}
				}]);
